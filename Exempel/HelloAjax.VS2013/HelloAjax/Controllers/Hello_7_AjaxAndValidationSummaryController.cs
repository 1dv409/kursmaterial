...
{
    public class Hello_7_AjaxAndValidationSummaryController : Controller
    {
        ...
        {
            // Fake a random non property error!
//            if (new Random().Next() % 2 == 0)
            {
                ModelState.AddModelError(String.Empty, "Ett slumpmässigt fel inträffade.");
            }
